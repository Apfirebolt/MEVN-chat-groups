    ...
    <div class="relative pt-6 pb-16 sm:pb-24">
      <main class="mt-16 mx-auto max-w-7xl px-4 sm:mt-24">
        <div class="text-center">
          ...
          >
            Chat Rooms is a portal where you can create your own rooms on topics
            which interests you, invite others to join and have interesting
            conversations with them. Or you can join existing rooms.
          </p>
